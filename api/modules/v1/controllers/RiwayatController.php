...
//            ]
    ...
    public function actionView($id_user){
        ...
        if($cek_riwayat!=null){
            foreach($cek_riwayat as $riwayat){
                $cek_dokter =  \api\modules\v1\models\Dokter::find()->where(['id_dokter' => $riwayat['id_dokter']])->one();
                $cek_penyakit = \api\modules\v1\models\DaftarPenyakit::find()->where(['id'=>$riwayat['diagnosa']])->one();

                $data[] = [
                    'id_riwayat' => $riwayat['id_riwayat'],
                    'id_pasien' => $riwayat['id_pasien'],
                    'id_dokter' => $riwayat['id_dokter'],
                    'nama_dokter' => $cek_dokter->nama_dokter,
                    'no_telp_dokter' => $cek_dokter->no_telp,
                    'alamat_praktik' => $cek_dokter->alamat_praktik,
                    'umur' => $riwayat['umur'],
                    'berat_badan' => $riwayat['berat_badan'],
                    'tinggi_badan' => $riwayat['tinggi_badan'],
                    'riwayat_penyakit_keluarga' => $riwayat['riwayat_kesehatan_keluarga'],
                    'keluhan_utama' => $riwayat['keluhan_utama'],
            //                'id_diagnosa' => $iddiagnosas,
                    'diagnosa' => $cek_penyakit->nama_penyakit,
                    ...
                    'head' => $riwayat['head'],
                    'neck' => $riwayat['neck'],
                    'thorax' => $riwayat['thorax'],
                    'abdomen' => $riwayat['abdomen'],
                    'ekstremitas' => $riwayat['ekstremitas'],
                ];
