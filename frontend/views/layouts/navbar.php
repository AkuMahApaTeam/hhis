<div class="pre-loader" style="display: none;">
    <div class="load-con">
        <img src="<?= Yii::$app->request->baseUrl.'/themes/SevenApp/img/logo.png' ?>" class="animated fadeInDown" alt="">
        <div class="spinner">
...
<div id="wrap">
    ...
    <header class="masthead">
        <div class="slider-container" id="slider">
            <div class="container">
                <div class="row mh-container" style="margin-top: 15%">
                    <h1 style="color: #19a085"><span>Patient </span> Medical History</h1>
                    <h3>Your health assistant App</h3>
        ...
        <div class="navbar navbar-static-top" id="nav" role="navigation">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1" style="margin-right: 35%">
