<section id="features">
    ...
    <section id="screenshots">
        ...
        <div id="owl-screenshots" class="owl-carousel">
            <div><img src="<?= Yii::$app->request->baseUrl.'/themes/SevenApp/img/weather.png' ?>screenshot.png" alt=""></div>
            <div><img src="<?= Yii::$app->request->baseUrl.'/themes/SevenApp/img/weather.png' ?>screenshot.png" alt=""></div>
            <div><img src="<?= Yii::$app->request->baseUrl.'/themes/SevenApp/img/weather.png' ?>screenshot.png" alt=""></div>
            <div><img src="<?= Yii::$app->request->baseUrl.'/themes/SevenApp/img/weather.png' ?>screenshot.png" alt=""></div>
            <div><img src="<?= Yii::$app->request->baseUrl.'/themes/SevenApp/img/weather.png' ?>screenshot.png" alt=""></div>
    ...
    <section id="subscribe">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6">
                    <img src="<?= Yii::$app->request->baseUrl.'/themes/SevenApp/img/iphone2.png' ?>" class="img-responsive hidden-xs scrollpoint sp-effect3" alt="">
                </div>
            </div>
        </div>
    </section>
    ...
    <section id="sponsors">
        <div class="container">
            <div class="row">
                <div class="col-md-3">
                    <a href="#" class="scrollpoint sp-effect2"><img src="<?= Yii::$app->request->baseUrl.'/themes/SevenApp/img/logo_gray.png' ?>" alt="" class="img-responsive"></a>
                </div>
                <div class="col-md-3">
                    <a href="#" class="scrollpoint sp-effect2"><img src="<?= Yii::$app->request->baseUrl.'/themes/SevenApp/img/logo_gray.png' ?>" alt="" class="img-responsive"></a>
                </div>
                <div class="col-md-3">
                    <a href="#" class="scrollpoint sp-effect1"><img src="<?= Yii::$app->request->baseUrl.'/themes/SevenApp/img/logo_gray.png' ?>" alt="" class="img-responsive"></a>
                </div>
                <div class="col-md-3">
                    <a href="#" class="scrollpoint sp-effect1"><img src="<?= Yii::$app->request->baseUrl.'/themes/SevenApp/img/logo_gray.png' ?>" alt="" class="img-responsive"></a>
                </div>
